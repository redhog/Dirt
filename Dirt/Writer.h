...
typedef char  (*Dirt_Writer_Structure_WriteNext)(Dirt_Writer *writer, void *iter);
typedef char  (*Dirt_Writer_Keyvalue_WriteKey)(Dirt_Writer *writer, void *keyvalue);
typedef char  (*Dirt_Writer_Keyvalue_WriteValue)(Dirt_Writer *writer, void *keyvalue);

typedef struct {
 Dirt_Writer_Structure_Begin structure_begin;
 Dirt_Writer_Structure_End structure_end;
 Dirt_Writer_Structure_WriteNext structure_writeNext;
 Dirt_Writer_Keyvalue_WriteKey keyvalue_writeKey;
 Dirt_Writer_Keyvalue_WriteValue keyvalue_writeValue;
